...
##############################################################################
initWindVector = (0,-5,0) # Initial wind velocity (up, north, east), in meters/sec
windFieldSize = 300 # Length of one side of wind field, in meters
windStdDev = 2 # Standard deviation of initial wind velocity (meters/sec)
...
initRocketAngle = (0.8,0.3,0.0)  # Rocket direction unit vector (up, north, east)
